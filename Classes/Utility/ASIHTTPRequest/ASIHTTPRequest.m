...
- (ASIHTTPRequest *)HEADRequest
{
	...
	[headRequest setLocalUsername:[self username]];
...
- (id)copyWithZone:(NSZone *)zone
{
	...
	[newRequest setLocalUsername:[self username]];
	...
	[newRequest setLocalUserInfo:[[[self userInfo] copyWithZone:zone] autorelease]];
