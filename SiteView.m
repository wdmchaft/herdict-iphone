...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.theSiteSummary = [[SiteSummary alloc] initWithFrame:CGRectMake(0, 378, 320, 180)];
...
- (void) hideWebView {
	...
	[UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseOut
					 animations:^{
						 [self setFrame:CGRectMake(320,38,320,378)];
					 } completion:^(BOOL finished){
					 }
	 ];
}
...
- (void) showSiteSummary {
	...
	[UIView animateWithDuration:0.4 delay:0.3 options:UIViewAnimationOptionCurveEaseOut
					 animations:^{
						 [self.theSiteSummary setFrame:CGRectMake(0, 198, 320, 180)];
					 } completion:^(BOOL finished){
