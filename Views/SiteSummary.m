...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		[self.loadingIndicator setFrame:CGRectMake(0.5 * (self.frame.size.width - (siteSummaryTab_loadingAnimation__diameter + 11 + siteSummaryTab_domainLoadingText__width)),
		...
		self.loadingText.font = [UIFont fontWithName:@"Helvetica-Bold" size:siteSummaryTab_domainLoadingText__fontSize];
